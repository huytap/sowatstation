...
class Product extends Model
{
    ...
    protected $fillable = ['title', 'slug', 'sowater_id', 'cover', 'cover_mobile', 'cover_detail', 'sub_title', 'description', 'photos', 'background', 'link_order', 'meta_title', 'meta_description', 'status', 'created_by', 'updated_by'];
