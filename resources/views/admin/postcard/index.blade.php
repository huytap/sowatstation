@php
    ...
    $menu_current = 'Postcard';
    $route_item = 'postcard.create';
                            ...
                            <tr data-row="0" class="datatable-row" style="left: 0px;">
                                ...
                                <td data-field="Actions">
                                    <span style="overflow: visible; position: relative; width: 125px;">
                                        <a href="{{route('postcard.edit', $item['id'])}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                            <span class="far fa-edit"></span>
                                        </a>
                                        <a href="{{route('postcard.destroy', $item['id'])}}" class="btn btn-sm btn-clean btn-icon btn-delete" title="Delete">
...
@section('js')
    <script type="text/javascript">
        $('.btn-delete').click(function(postcard){
            postcard.preventDefault();
