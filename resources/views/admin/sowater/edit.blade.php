...
<div class="card card-custom gutter-b example example-compact">
    ...
    @endif
    <!--begin::Form-->
    <form class="form" action="{{route('sowater.update', $sowater['id'])}}" method="POST" enctype="multipart/form-data">
        @csrf @method('PUT')
        ...
        <div class="card-body">
            ...
            @include('admin.sowater._form', ['model' => $sowater])
        </div>
        <div class="card-footer">
            <button type="submit" class="btn btn-primary mr-2">Save</button>
            <a href="{{route('sowater.index')}}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
    <!--end::Form-->
</div>
