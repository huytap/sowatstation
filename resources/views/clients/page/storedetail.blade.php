...
<section class="project store">
    <div class="container">
	<img src="{{asset('clients/images/creative/store-cover.jpg')}}" class="img-fluid">
	<div class="project__title">
		<h1>Product: DRINKING GAME CARD</h1>
	</div>
	<div class="project__content">
		<div class="row content-m">
            ...
            <div class="project__content--images">
                <img class="img-fluid" src="{{asset('clients/images/creative/store-desc.jpg')}}" alt=""/>
            </div>
            <div class="col-md-12">
                <a href="#" class="btn__join"><img src="{{asset('clients/images/btnOrder.png')}}" alt=""></a>
            </div>
        </div>
    </div>
    <div class="creative">
