        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 col-md-offset-1">
                ...
                <ul class="footer__social">
                    <li><a href="{!! strip_tags(Setting::getValue('facebook')) !!}" target="_blank"><img src="{{asset('clients/images/facebook.png')}}" alt="" class="img-fluid"></a></li>
                    <li><a href="{!! strip_tags(Setting::getValue('instagram')) !!}" target="_blank"><img src="{{asset('clients/images/instagram.png')}}" alt="" class="img-fluid"></a></li>
                </ul>
                <div class="footer__follow">
                    Contact us
                </div>
